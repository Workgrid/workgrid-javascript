...
export declare type MutationHandler<Variables = {}, Data = any> = Handler<Data> & {
...
export declare const actionNotification: MutationHandler<{
    id: string;
    data: any;
}>;
export declare const deleteNotification: MutationHandler<{
    id: string;
}>;
export declare const notificationViewed: MutationHandler<{
    id: string;
}>;
export declare const notificationDetailViewed: MutationHandler<{
    id: string;
}>;
